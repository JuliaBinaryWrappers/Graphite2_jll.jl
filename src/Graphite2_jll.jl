...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Graphite2_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("3b182d85-2403-5c21-9c21-1e1f0cc25472"))
...
if best_platform === nothing
    @debug("Unable to load Graphite2; unsupported platform $(triplet(platform_key_abi()))")
else
